...
//Enemy Sprites
spr_move = spr_blood_slime_big;
spr_attack = spr_blood_slime_big_attack;
spr_hurt = spr_blood_slime_big_hurt;
spr_die = spr_blood_slime_big_die;
...
enemy_scripts[ENEMYSTATE.DIE] = blood_slime_big_die;